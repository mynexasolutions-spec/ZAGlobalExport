      ...
      <section className="about-info section-padding">
        <div className="container">
          ...
          <div className="about-lead">
            <p>At ZA GLOBAL EXPORTS, we are committed to supplying high-quality, nutritious food products to customers across India, the Middle East, and global markets. Our portfolio includes premium rice, pulses, spices, fresh fruits, vegetables, and more, sourced from trusted suppliers.</p>
            <p>Our experienced team carefully manages every stage of the export process—from sourcing and quality control to processing, packaging, and timely delivery—to meet our customers’ requirements.</p>
            <p>As an ISO-certified company with the necessary legal export approvals, we maintain high standards of quality, hygiene, food safety, freshness, and reliability.</p>
